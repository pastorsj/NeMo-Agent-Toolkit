...
class MilvusRetrieverConfig(RetrieverBaseConfig, name="milvus_retriever"):
    """
    Configuration for a Retriever which pulls data from a Milvus vector database service.

    ## Details
    Name: Milvus Retriever
    Icon: ![Icon](https://cdn.simpleicons.org/milvus/00A1EA)
    """
