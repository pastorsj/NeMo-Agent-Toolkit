...
from .register import CatalystTelemetryExporter as CatalystTelemetryExporterConfig


class CatalystTelemetry(CatalystTelemetryExporterConfig, NatTelemetryExporter):
